...
直接试玩可运行 `./scripts/godot.sh --path .`。大厅中的“斗地主”、“大众麻将”和“四川血战”均可完整玩到结算；点击真实手牌后使用“出牌”或“换三张”，鸣牌、定缺和其他选项会直接按规则引擎的合法操作列出，也可以使用“提示”或“托管”。斗地主未完成牌局会自动保存并在下次进入时恢复；麻将恢复在三种玩法接通后统一补齐。
