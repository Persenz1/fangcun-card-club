...
直接试玩可运行 `./scripts/godot.sh --path .`。大厅中的斗地主、大众麻将、四川血战和四人日麻均可完整玩到结算；点击真实手牌后使用“出牌”或“换三张”，鸣牌、定缺、立直弃牌和其他选项会直接按规则引擎的合法操作列出，也可以使用“提示”或“托管”。四种玩法的未完成牌局都会自动保存，下次从大厅对应入口继续。
