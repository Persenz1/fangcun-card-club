...
近期新增设计：[麻将混合渲染](architecture/麻将混合渲染.md)；近期冻结规则：[斗地主规则](rules/斗地主规则.md)、[大众麻将规则](rules/大众麻将规则.md)、[四川麻将规则](rules/四川麻将规则.md)、[日式立直麻将规则](rules/日式立直麻将规则.md)；近期任务：[麻将公共应用与表现边界](tasks/2026-08-01-014-麻将公共应用与表现边界.md)。
